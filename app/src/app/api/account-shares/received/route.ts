 ...
 * GET /api/account-shares/received
 */
export async function GET(req: NextRequest) {
  try {
    ...
    return SUCCESS.json('Received shares retrieved successfully', {
      shares,
      pagination: {
        total,
        limit,
    ...
    logger.error('Error getting received shares', {
      module: 'AccountShares',
      label: 'GET_RECEIVED_SHARES',
